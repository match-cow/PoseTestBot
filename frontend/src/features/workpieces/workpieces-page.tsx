            ...
            {selected ? <Card data-testid="workpiece-selected-object">
              ...
              <CardContent className="space-y-6 pt-5">
                ...
                <div className="grid grid-cols-4 overflow-hidden rounded-lg border text-xs">
                  <div className="border-r p-3"><div className="text-[10px] uppercase tracking-wide text-muted-foreground">Dimensions</div><div className="mt-1 font-mono text-[11px]">{formatBounds(selected.extraction.bounds_mm)}</div></div>

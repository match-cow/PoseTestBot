  ...
  return (
    <div className="space-y-6">
      ...
      <ProcessHandoff
        ...
        description="Save default aliases, mounting modes, and orientation here. Disconnected-camera defaults are retained. “Use in run” is a browser draft; Workflow step 1 snapshots and may customize the alias and camera settings owned by the selected run."
        to={workflowHref}

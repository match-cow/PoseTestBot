...
# from https://github.com/christophhagen/averaging-quaternions
...
def main():
    ...
    parser.add_argument(
        "input_file", help="Path to the input json file with all transformations"
    )
    ...
    for d in tqdm(data.values()):
        ...
        # get the transformation from the aruco marker to the sensor
    ...
    average_quaternion = averageQuaternions(np.array(quaternions)).tolist()
    ...
    # Save the average quaternions and positions to a JSON file

...
def compute_average_transformation(data: dict) -> dict:
    """Computes the average quaternion and position from a JSON file.

    Args:
        data: A dictionary containing the transformation data.
...
def main():
    ...
    parser.add_argument(
        "--average",
        action="store_true",
        help="Compute and save the average transformation.",
    )
    ...
    if args.average:
        average_transformation = compute_average_transformation(updated_data)
